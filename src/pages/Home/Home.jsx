...
//       case KEY_DOWN:
//         e.preventDefault();
//         // Move focus to first TitleCard section
//         const firstTitleCardSection = document.querySelector('.TitleCards');
      
      
//         if (firstTitleCardSection) {
//           const firstCard = firstTitleCardSection.querySelector('.card');
//           if (firstCard) {
           
           
//             firstCard.focus();
//             // Dispatch event to set focus on first card of first section
//             window.dispatchEvent(new CustomEvent('setCardFocus', { 
//               detail: 0
//             }));
//           }
...
//             <TitleCards key={idName} title={title} category={category} idName={idName} tabIndex="-1" />
//         ))}
//     </div>
